              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Product Categories</b>        :<span class="label label-primary pull-right"><?php echo $row->product_category; ?></span></li>
                    <li class="list-group-item"><b>Capital Price</b>  :<span class="label label-warning pull-right">Ksh. <?php echo number_format($row->purchase_price); ?></span></li>
                    <li class="list-group-item"><b>Selling price</b>     :<span class="label label-warning pull-right">Ksh. <?php echo $row->sell_price; ?></span></li>
                    <li class="list-group-item"><b>Advantage</b>           :<span class="label label-success pull-right">Ksh. <?php echo number_format(($row->sell_price - $row->purchase_price)); ?></span></li>
