...
<meta charset="utf-8">
  ...
  <title>Fajir Holdings | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Fajir Holdings</b>POS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Fajir Holdings|</b>POS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <!-- The user image in the navbar-->Welcome,
