...
$pdf->Cell(60,10,'Fajir Holdings',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Address: Mombasa',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Selling mattresses',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'No. Tel: +25471495-0777',0,1,'C');
...
$pdf->SetFont('Arial','BU',5);
$pdf->Cell(45,4 ,'Returns accepted a maximum of 3 days after purchase',0,0,'C');
